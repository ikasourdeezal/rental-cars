      ...
      <div className="px-8 lg:px-28 py-12 lg:py-0 h-screen flex items-center relative">
        ...
        <div className="space-y-8 text-center lg:text-left lg:max-w-lg">
          <div className="font-bold space-y-2">
            <h3 className="text-xl">Go Your Own Way. Save Big.</h3>
            <h1 className="text-[3.2rem] leading-tight">
              Rent Your <span className="text-custom-orange">Dream</span> Car.
            </h1>
          </div>
          <div>
            <p className="text-custom-grey">
              All rentals include unlimited miles, flexible pick-up, 
              and our best price guarantee. Your adventure, on your terms.
            </p>
          </div>
